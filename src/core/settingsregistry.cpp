    ...
    : QObject(parent)
{
    ...
    m_entries = {
        ...
        setting(QStringLiteral("applications"), tr("Applications"), tr("Manage installed applications, configuration, storage, cache, data, and removal through OmniStore"),
                QStringLiteral("apps"), QStringLiteral("applications"), QStringLiteral("apps"), tr("Apps & notifications"),
                {QStringLiteral("installed apps"), QStringLiteral("application"), QStringLiteral("app settings"),
                 QStringLiteral("configuration"), QStringLiteral("cache"), QStringLiteral("app data"),
                 QStringLiteral("storage"), QStringLiteral("uninstall"), QStringLiteral("omnistore")},
                true, QStringLiteral("control"), QStringLiteral("user-data"), QStringLiteral("secondary")),
        ...
        setting(QStringLiteral("control-center"), tr("Control Center"), tr("Arrange Meo Quick Settings tiles and choose their visibility and density"),
                ...
                true, QStringLiteral("control"), QStringLiteral("reversible"), QStringLiteral("neutral")),
        setting(QStringLiteral("shell"), tr("Desktop & shell"), tr("Configure Shelf, Launcher, notification surfaces, Time Center, and top-panel tasks"),
                QStringLiteral("dashboard_customize"), QStringLiteral("shell"), QStringLiteral("system"), tr("System"),
                {QStringLiteral("shell"), QStringLiteral("desktop"), QStringLiteral("shelf"), QStringLiteral("dock"),
                 QStringLiteral("launcher"), QStringLiteral("notification center"), QStringLiteral("time center"),
                 QStringLiteral("top tasks"), QStringLiteral("panel"), QStringLiteral("osd")},
                true, QStringLiteral("control"), QStringLiteral("reversible"), QStringLiteral("neutral")),
        ...
        setting(QStringLiteral("language"), tr("Language & region"), tr("Language, regional formats, input, time, and weather location"),
                QStringLiteral("language"), QStringLiteral("language-region"), QStringLiteral("system"), tr("System"),
                {QStringLiteral("language"), QStringLiteral("locale"), QStringLiteral("region"), QStringLiteral("weather"),
                 QStringLiteral("city"), QStringLiteral("input method"), QStringLiteral("time zone")},
                true, QStringLiteral("control"), QStringLiteral("reversible"), QStringLiteral("neutral")),
        ...
        setting(QStringLiteral("app-permissions"), tr("App permissions"), tr("Review verified Flatpak sandbox permissions by application"),
                ...
                true, QStringLiteral("inspector"), QStringLiteral("read-only"), QStringLiteral("neutral")),
        setting(QStringLiteral("session-entry"), tr("Lock screen & login"), tr("Preview Meo lock-screen presentation and privacy defaults"),
                QStringLiteral("lock"), QStringLiteral("session-entry"), QStringLiteral("privacy"), tr("Privacy & security"),
                {QStringLiteral("lock"), QStringLiteral("login"), QStringLiteral("weather"), QStringLiteral("media"),
                 QStringLiteral("notifications"), QStringLiteral("privacy"), QStringLiteral("session entry")},
                true, QStringLiteral("preview"), QStringLiteral("read-only"), QStringLiteral("neutral")),
        ...
        setting(QStringLiteral("hardware"), tr("Hardware & drivers"), tr("Inspect verified graphics, fingerprint, display, and driver capabilities"),
                QStringLiteral("memory"), QStringLiteral("hardware"), QStringLiteral("system"), tr("System"),
                {QStringLiteral("nvidia"), QStringLiteral("gpu"), QStringLiteral("driver"), QStringLiteral("fingerprint"),
                 QStringLiteral("fprint"), QStringLiteral("hardware"), QStringLiteral("thunderbolt")},
                true, QStringLiteral("inspector"), QStringLiteral("read-only"), QStringLiteral("primary")),
        setting(QStringLiteral("recovery"), tr("Recovery"), tr("Review update snapshots, fallback kernel, and repair protection"),
                QStringLiteral("restore"), QStringLiteral("recovery"), QStringLiteral("system"), tr("System"),
                {QStringLiteral("recovery"), QStringLiteral("snapshot"), QStringLiteral("rollback"), QStringLiteral("previous boot"),
                 QStringLiteral("kernel"), QStringLiteral("repair")},
                true, QStringLiteral("inspector"), QStringLiteral("read-only"), QStringLiteral("tertiary")),
        setting(QStringLiteral("system-center"), tr("Services & logs"), tr("Understand systemd services, timers, and recent failures"),
                QStringLiteral("settings_applications"), QStringLiteral("system-center"), QStringLiteral("system"), tr("System"),
                {QStringLiteral("systemd"), QStringLiteral("systemctl"), QStringLiteral("journalctl"), QStringLiteral("service"),
                 QStringLiteral("timer"), QStringLiteral("log"), QStringLiteral("startup")},
                true, QStringLiteral("inspector"), QStringLiteral("privileged"), QStringLiteral("neutral")),
